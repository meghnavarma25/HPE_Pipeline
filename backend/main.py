...
base_path = r"C:\Users\rbg21\OneDrive\Documents\hpe\New folder\backend"
kriya_path = r"C:\Users\rbg21\OneDrive\Documents\hpe\New folder\backend\roberta-finetuned-financial-20250421T111618Z-001\roberta-finetuned-financial"  # path to your folder with model files

kriya_model = pipeline("text-classification", model=kriya_path, tokenizer=kriya_path)
